...
class Trainer():
    ...
    def train_step(self, batch, accumulation_steps=1):
        ...
        # NO optimizer.step() here - controlled by training loop
    ...
    def train(self, train_dataset, **kwargs):
        ...
        # Setup scheduler
        # T_max should account for accumulation steps (effective batches)
        effective_batches = len(train_loader) // accumulation_steps
        self.scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
            self.model.optimizer, T_max=epochs * effective_batches
        )
